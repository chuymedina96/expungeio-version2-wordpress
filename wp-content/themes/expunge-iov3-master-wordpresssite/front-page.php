      ...
      <div class="col-lg-12">
        <img class="img-responsive logo" src="img/expunge.iologo1.png" alt=""></img>
          <div class="intro-text" id="fancy">
            ...
            <span class="skills">If you were arrested in IL when you were under 18, you probably have a juvenile record. <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal" class="btn btn-lg btn-warning button-hover">Learn More!</a></span>
          </div>
          <br>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <div id="bank" class="disclaimer text-center">
                ...
                <span class="skills">This site <span style="color:#0cc;"><strong><em>does not serve as a substitute for legal advice from a licensed attorney</em></strong></span>. If you're unsure about any questions, you can speak with a lawyer (for free!) by clicking <a href="#legal">Free Legal Help</a> at the top of the page.<br><br>
              ...
              <div id="resultss" class="text-center">
                ...
                <a href="#portfolioModal5" class="btn btn-info" data-toggle="modal">2014</a>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2>Questions?</h2>
          <p class="about-text">
            Stop by the Juvenile Expungement Help Desk or just give us a call!! Attorneys are at the help desk every day and would be happy to meet with you in person or speak with you by phone.
          </p><br><br>
          ...
          <p>
            <a style="color: #fff;" href="tel:(312) 229-6359">
              (312) 229-6359
            </a><br><br>
            This is a free service & the lawyers are eager to help you!
          </p>
          <p>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>
          Juvenile records in Cook County (including Chicago): Contact the Juvenile Expungement Help Desk at (312) 229-6359 and a lawyer will be able to help you.

          To get information about an arrest in Chicago (date, age, juvenile vs. adult), you can get your arrest record (aka rap sheet) at:
...
<i class="fa fa-phone fa-fw"></i> (312) 229-6359<br>
...
<p>
  The attorneys at the <a href="https://www.facebook.com/JuvenileExpungementHelpDesk" target = "_blank">juvenile expungement help desk</a> can help you fill out and submit your paperwork, for free.
</p><br><br>

<div class="well well-sm">
  <p class="h3">
     If you have any questions, don't hesitate to call free legal help at (312) 229-6359
  </p>
</div>
      </div>
                ...
                <div class="panel panel-default">
                  ...
                  <div id="collapse7" class="panel-collapse collapse">
                    <div class="panel-body">
                      <p>
                        If you were arrested under age 18 or had a case in juvenile court, you have a juvenile record.  Even though a juvenile record is not the same as an adult conviction. A juvenile arrest, or a juvenile court case, can still show up on a background check, and very often, still is a barrier to things you need for your future. Remember, even arrests that never went to court create a record!
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div id="collapse8" class="panel-collapse collapse">
                    <div class="panel-body">
                      <p>
                       ...
                       If a job application asks you about criminal convictions, you may not have to reveal your juvenile record. If you think a job has seen your juvenile record or that you have been turned down for a job because of a juvenile record, call the Juvenile Expungement Help Desk at <a href="tel:312-229-6359">312-229-6359</a> to learn more about your rights.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="panel-group" id="q2">
                <div class="panel panel-default">
                  ...
                  <div id="collapse2" class="panel-collapse collapse">
                    <div class="panel-body">
                      <p>
                        Remember that free legal help is available to help you complete the process! Use it! At the Juvenile Expungement Help Desk, attorneys can walk you through this entire process - many people only need to visit the help desk one time! 
                        To petition for juvenile expungement, you will need to:
                        <ol>
                          <li>
                            Get a copy of your RAP sheet (arrest record).  If you have one, bring it with you, but if not, don’t worry - you can get a copy for free at the Juvenile Expungement Help Desk
                          </li>
                          <li>
                            Complete court paperwork, including a notice and petition
                          </li>
                          <li>
                            File your petition. Remember, attorneys will help you complete all of the documents you need, and you can usually get your RAP sheet, complete paperwork, and file your petition the same day
                          </li>
                          <li>
                            Attorneys will attend your expungement hearing for you, or will give you detailed instructions if you are representing yourself.  Many people don’t need to come back for their hearings, and only need to make one trip to the help desk.
                          </li>
                        </ol>
                  ...
                  <div id="collapse5" class="panel-collapse collapse">
                    <div class="panel-body">
                      <p>
                       ...
                       Usually, a court date is scheduled about 45 days from the petition date. After a judge approves the petition on the court date, it takes about 2 months for the police to erase records and for the records to no longer appear on a background check. So in total, the whole process is typically over in 100 days or less. For most people, Most of this process will be handled by help desk staff, will be handled by your attorney, and many people don’t need to come back to the help deskcourt after their first visit. If you have questions about this process, call the help desk for more information!
              ...
              <div class="panel-group" id="q6">
                <div class="panel panel-default">
                  ...
                  <div id="collapse6" class="panel-collapse collapse">
                    <div class="panel-body">
                      <p>
                        Whether your petition is approved is up to the judge. However, in the past, almost all petitions have been approved. The attorney you speak with will evaluate your record to make sure it is eligible beforehand, so you can feel confident about the court process.
                      </p>
                    </div>
                  </div>
                </div>
